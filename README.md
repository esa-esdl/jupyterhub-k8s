...
* `cd jupyterhub-k8s`
* `vim config.yaml`
  * `proxy.secretToken`: generate the value https://zero-to-jupyterhub-with-kubernetes.readthedocs.io/en/latest/reference.html?highlight=secrettoken#proxy-secrettoken
